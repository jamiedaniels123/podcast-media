...
// Get the actions from the queue table
	...
	$sqlQuery = "SELECT * FROM queue_commands AS cq, command_routes AS cr where cq.cq_command=cr.cr_action AND cr.cr_execute='admin-api' AND cq.cq_status = 'N' ORDER BY cq.cq_command";
//	echo $sqlQuery;
