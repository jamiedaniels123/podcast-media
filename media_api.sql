...
# Dumping database structure for media_api
CREATE DATABASE IF NOT EXISTS `media_api` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `media_api`;


# Dumping structure for table media_api.command_queue
...
# Dumping data for table media_api.command_queue: ~36 rows (approximately)
...
# Dumping structure for table media_api.message_queue
...
# Dumping data for table media_api.message_queue: ~0 rows (approximately)
