...
# Dumping database structure for encoder-api
CREATE DATABASE IF NOT EXISTS `encoder-api` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `encoder-api`;


# Dumping structure for table encoder-api.api_destinations
...
# Dumping data for table encoder-api.api_destinations: ~4 rows (approximately)
...
INSERT INTO `api_destinations` (`ad_index`, `ad_name`, `ad_url`, `ad_ip`, `ad_update`) VALUES
	(1, 'encoder-api', 'http://podcast-api-dev.open.ac.uk', '137.108.130.170', '2011-06-10 10:02:09'),
...
# Dumping structure for table encoder-api.command_routes
...
# Dumping data for table encoder-api.command_routes: ~14 rows (approximately)
...
INSERT INTO `command_routes` (`cr_index`, `cr_source`, `cr_destination`, `cr_action`, `cr_function`, `cr_callback`, `cr_route_type`) VALUES
	(1, 'encoder-api', 'encoder-api', 'transcode-media', 'doTranscodeMedia', 'transcode-media', 'queue'),
	(2, 'encoder-api', 'encoder-api', 'transcode-media-and-deliver', 'doTranscodeMediaAndDeliver', 'transcode-media-and-deliver', 'queue'),
	(3, 'encoder-api', 'encoder-api', 'transfer-file-to-media-server', 'doTransferFileToMediaServer', 'transfer-file-to-media-server', 'queue'),
	(4, 'encoder-api', 'encoder-api', 'transfer-folder-to-media-server', 'doTransferFolderToMediaServer', 'transfer-folder-to-media-server', 'queue'),
	(5, 'encoder-api', 'media-api', 'delete-file-on-media-server', 'doDeleteFileOnMediaServer', 'delete-file-on-media-server', 'direct'),
	(6, 'encoder-api', 'media-api', 'delete-folder-on-media-server', 'doDeleteFolderOnMediaServer', 'delete-folder-on-media-server', 'direct'),
	(7, 'encoder-api', 'media-api', 'update-file-metadata', 'doUpdateFileMetaData', 'update-file-metadata', 'queue'),
	(8, 'encoder-api', 'media-api', 'update-folder-metadata', 'doUpdateFolderMetaData', 'update-folder-metadata', 'queue'),
	(9, 'encoder-api', 'media-api', 'update-list-of-files-metadata', 'doUpdateListOfFilesMetaData', 'update-list-of-files-metadata', 'queue'),
	(10, 'encoder-api', 'media-api', 'set-permissions-folder', 'doSetPermisssionsFolder', 'set-permissions-folder', 'queue'),
	(11, 'encoder-api', 'media-api', 'check-file-exists', 'doCheckFileExists', 'check-file-exists', 'direct'),
	(12, 'encoder-api', 'media-api', 'check-list-of-files-exists', 'doCheckListOfFilesExists', 'check-list-of-files-exists', 'direct'),
	(13, 'encoder-api', 'media-api', 'check-folder-exists', 'doCheckFolderExists', 'check-folder-exists', 'direct'),
	(14, 'encoder-api', 'media-api', 'status', 'doStatus', 'status', 'direct');
/*!40000 ALTER TABLE `command_routes` ENABLE KEYS */;


# Dumping structure for table encoder-api.queue_commands
...
# Dumping data for table encoder-api.queue_commands: ~101 rows (approximately)
...
# Dumping structure for table encoder-api.queue_messages
...
# Dumping data for table encoder-api.queue_messages: ~0 rows (approximately)
