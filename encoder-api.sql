...
# Dumping structure for table encoder-api.api_log
...
# Dumping data for table encoder-api.api_log: ~0 rows (approximately)
/*!40000 ALTER TABLE `api_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_log` ENABLE KEYS */;


# Dumping structure for table encoder-api.command_queue
...
# Dumping data for table encoder-api.command_queue: ~36 rows (approximately)
...
# Dumping structure for table encoder-api.message_queue
...
# Dumping data for table encoder-api.message_queue: ~0 rows (approximately)
