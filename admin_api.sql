...
# Dumping database structure for admin_api
CREATE DATABASE IF NOT EXISTS `admin_api` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `admin_api`;


# Dumping structure for table admin_api.api_destinations
...
# Dumping data for table admin_api.api_destinations: ~4 rows (approximately)
...
# Dumping structure for table admin_api.command_routes
...
# Dumping data for table admin_api.command_routes: ~13 rows (approximately)
...
INSERT INTO `command_routes` (`cr_index`, `cr_source`, `cr_destination`, `cr_action`, `cr_callback`, `cr_route_type`) VALUES
	(1, 'admin-api', 'encoder-api', 'transcode-media', 'transcode-media', 'queue'),
	(2, 'admin-api', 'encoder-api', 'transcode-media-and-deliver', 'transcode-media-and-deliver', 'queue'),
	(3, 'admin-api', 'encoder-api', 'transfer-file-to-media-server', 'transfer-file-to-media-server', 'queue'),
	(4, 'admin-api', 'encoder-api', 'transfer-folder-to-media-server', 'transfer-folder-to-media-server', 'queue'),
	(5, 'admin-api', 'media-api', 'delete-file-on-media-server', 'delete-file-on-media-server', 'direct'),
	(6, 'admin-api', 'media-api', 'delete-folder-on-media-server', 'delete-folder-on-media-server', 'direct'),
	(7, 'admin-api', 'media-api', 'update-file-metadata', 'update-file-metadata', 'queue'),
	(8, 'admin-api', 'media-api', 'update-folder-metadata', 'update-folder-metadata', 'queue'),
	(9, 'admin-api', 'media-api', 'update-list-of-files-metadata', 'update-list-of-files-metadata', 'queue'),
	(10, 'admin-api', 'media-api', 'set-permissions-folder', 'set-permissions-folder', 'queue'),
	(11, 'admin-api', 'media-api', 'check-file-exists', 'check-file-exists', 'direct'),
	(12, 'admin-api', 'media-api', 'check-list-of-files-exists', 'check-list-of-files-exists', 'direct'),
	(13, 'admin-api', 'media-api', 'check-folder-exists', 'check-folder-exists', 'direct'),
	(14, 'admin-api', 'media-api', 'status', 'status', 'direct');
/*!40000 ALTER TABLE `command_routes` ENABLE KEYS */;


# Dumping structure for table admin_api.queue_commands
...
# Dumping data for table admin_api.queue_commands: ~45 rows (approximately)
...
# Dumping structure for table admin_api.queue_messages
...
# Dumping data for table admin_api.queue_messages: ~0 rows (approximately)
